...
export function CardOg() {
  return (
    ...
    <Card>
      ...
      <CardTitle>Catchy Captions</CardTitle>
      <CardDescription>
        Instantly generate unique and creative captions that match your style and vibe, perfect for boosting engagement on every post.
      </CardDescription>
    </Card>
    <Card>
      <CardSkeletonContainer>
      ...
      <CardDescription>
        Get song recommendations that align with current trends, so your content always stays fresh and relevant.
      </CardDescription>
    </Card>
    <Card>
      <CardSkeletonContainer>
      ...
      <CardTitle>Profile Perfection</CardTitle>
      <CardDescription>
        Build a standout social media profile with smart suggestions that make your online presence look polished and professional.
      </CardDescription>
    </Card>
    </div>
  );
...
const Skeleton3 = () => {
    ...
    <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
      <div className="flex flex-row shrink-0 justify-center items-center gap-2">
        ...
        <Container className="circle-3">
          <InstagramLogo className="h-8 w-8 dark:text-white" />
        </Container>
  ...
  <div className="scan-line">
    <div className="w-10 h-32 absolute top-1/2 -translate-y-1/2 -left-10">
      <Sparkles />
    </div>
  </div>
</div>
...
export const InstagramLogo = ({ className }: { className?: string }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" id="instagram" width="34">
...
export const GeminiLogo = ({ className }: { className?: string }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="34" viewBox="0 0 48 48" id="spotify">
